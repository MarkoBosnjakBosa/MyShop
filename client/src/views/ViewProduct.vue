                            ...
                            <div class="row">
                                ...
                                <div v-if="product.quantity" class="col-md-6">
                                    <div class="mb-3 input-group">
                                        <input type="number" id="selectedQuantity" min="1" :max="product.quantity" class="form-control" :class="{'errorField' : product.selectedQuantity < 1 || product.selectedQuantity > product.quantity}" v-model="product.selectedQuantity"/>
