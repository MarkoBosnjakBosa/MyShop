...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            checkRoutePath() {
                if(this.routePath != "/login" && this.routePath != "/authentication" && this.routePath != "/registration" && this.routePath != "/confirm/registration" && this.routePath != "/forgot/credentials") return true;
                else return false;
            },
            openHome() {
