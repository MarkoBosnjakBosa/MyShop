...
const registration = require("./routes/registration.js")(app, bcryptjs, models, emailEvent, validation, reCaptcha_v2_SecretKey);
...
const products = require("./routes/admin/products.js")(app, models, uploadImages, fs, path, validation, validationHelper);
